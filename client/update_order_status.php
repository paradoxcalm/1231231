...
require_once 'notify_user.php'; // ✅ добавлено
...
if (!$orderId || !$newStatus || !in_array($role, ['admin', 'manager', 'client'])) {
    echo json_encode(['success' => false, 'message' => 'Недостаточно прав или данных']);
    exit;
}
